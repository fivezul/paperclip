...
const KNOWN_DEFAULTS: Record<string, AdapterCapabilities> = {
  antigravity_local: { supportsInstructionsBundle: false, supportsSkills: false, supportsLocalAgentJwt: true, requiresMaterializedRuntimeSkills: false, supportsAcp: false },
